...
public class User {
    ...
    public User(int age, int cityId, int stateId, int stockId, int type, String name, String email, String username, String password, String mobile, String gender, String bloodGroup, String address) {
        this.age = age;
        this.cityId = cityId;
