<%-- 
    Document   : footer
    Created on : 24 Oct, 2019, 11:08:14 AM
    Author     : nimar
--%>
      ...
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3">
          <div class="foot-about">
            ...
            <p>Ajava10 NGO, One Of India's Leading NGOs In Today's Date. Founded In 2018, Since We Have Organized Over 30 Blood Donation Camp All Around The Nation.</p>
      ...
      <div class="row">
        <div class="col-12">
          <p class="m-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Project Is The Property Of Ajava10AM <i class="fa fa-heart-o" aria-hidden="true"></i>
