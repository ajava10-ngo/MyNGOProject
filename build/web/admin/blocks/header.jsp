<%-- 
    Document   : header
    Created on : 2 Nov, 2019, 3:15:23 PM
    Author     : Ritesh Verma
--%>
  ...
  <div class="mdc-toolbar__row">
    ...
    <section class="mdc-toolbar__section mdc-toolbar__section--align-end" role="toolbar">
      <div class="mdc-menu-anchor">
        <a href="../logoutController" class="mdc-toolbar__icon toggle mdc-ripple-surface" data-toggle="dropdown" toggle-dropdown="notification-menu" data-mdc-auto-init="MDCRipple">
